...
export const DAEMON_WORKER_ROLE_ENV = `${INTERNAL_ENV_PREFIX}DAEMON_WORKER`;
export const DAEMON_WORKER_TOKEN_ENV = `${INTERNAL_ENV_PREFIX}DAEMON_WORKER_TOKEN`;
export const DAEMON_WORKER_ACTIVE_SESSION_ID_ENV = `${INTERNAL_ENV_PREFIX}DAEMON_WORKER_ACTIVE_SESSION_ID`;
export const DAEMON_WORKER_SUPERVISOR_SOCKET_ENV = `${INTERNAL_ENV_PREFIX}DAEMON_SUPERVISOR_SOCKET`;
export const DAEMON_WORKER_RECOVERY_JOURNAL_ENV = `${INTERNAL_ENV_PREFIX}DAEMON_WORKER_RECOVERY_JOURNAL`;
export const DAEMON_WORKER_STARTUP_GATE_FD_ENV = `${INTERNAL_ENV_PREFIX}DAEMON_WORKER_STARTUP_GATE_FD`;
